...
defineOptions({ meta: defineMeta({ title: 'Vue 3 Shadow DOM route' }) });
</script>

<template>
  <BaseLayout>
    <header class="ds-page-header">
      <h1>Vue 3 Shadow DOM route</h1>
      <p class="ds-description">
        A Vue 3 route rendering imported Widgets into isolated declarative
        shadow roots.
      </p>
    </header>
    ...
    <section class="ds-section">
      ...
      <div class="shadow-slot-example">
        <SlotPanel :widget="{ id: 'vue3-slot-panel' }">
          <template #default>
