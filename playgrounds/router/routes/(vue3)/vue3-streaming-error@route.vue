  ...
  <BaseLayout>
    <header class="ds-page-header">
      ...
      <p class="ds-description">
        This page demonstrates streaming SSR error recovery. The failing widget is wrapped in an
        onErrorCaptured boundary so the rest of the page stays functional.
      </p>
    </header>
    ...
    <section class="ds-section">
      ...
      <VueFailDemo :widget="{ fallback: { pending: Loading, error: ErrorFallback } }" id="fail:0" />
    </section>
