...
import Layout from '~/routes/(components)/preact/Layout';
...
export const meta = defineMeta({ title: 'Preact Shadow DOM route' });

export default function Page() {
  return (
    <Layout>
      <header class="ds-page-header">
        <h1>Preact Shadow DOM route</h1>
        <p class="ds-description">
          A Preact route rendering imported Widgets into isolated declarative
          shadow roots.
        </p>
      </header>
      ...
      <section class="ds-section">
        ...
        <div class="shadow-slot-example">
          <SlotPanel widget={{ id: 'preact-slot-panel' }}>
